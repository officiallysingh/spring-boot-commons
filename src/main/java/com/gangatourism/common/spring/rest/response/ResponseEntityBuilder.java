package com.gangatourism.common.spring.rest.response;

import com.gangatourism.common.spring.rest.response.builder.AbstractResponseBuilder;
import com.gangatourism.common.spring.rest.response.builder.BodyBuilder;
import com.gangatourism.common.spring.rest.response.builder.HeaderBuilder;
import com.gangatourism.common.spring.rest.response.builder.StatusBuilder;
import java.net.URI;
